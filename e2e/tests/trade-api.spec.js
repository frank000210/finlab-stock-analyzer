...
// HH10：trade.py 的 GET /pending、POST /approve 是無驗證、會動到
// TradeApprovalService 記憶體狀態的真實端點，驅動整個交易核准流程，但
// 既有測試（trade-approval.spec.js）全部用 page.route() mock 掉，從沒
// 真的打過後端。比照 signal-rules-api.spec.js 的做法，直接打真實端點。
//
