    ...
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        data: {
          as_of: '2026-07-07',
          items: [
            { symbol: '2330', ok: true, price: 2440, chg_pct: -0.8, trend: '多頭排列', rsi: 55.2, stop_dist_pct: 5.3, vol_ratio: 1.8, range_pos_pct: 88, tags: [{ t: '多頭排列', tone: 'up' }, { t: '爆量 1.8×', tone: 'warn' }] },
            { symbol: '2454', ok: true, price: 1400, chg_pct: 1.2, trend: '盤整', rsi: 48, stop_dist_pct: 6.1, vol_ratio: 0.9, range_pos_pct: 50, tags: [{ t: '盤整', tone: 'flat' }] },
          ],
        },
      }),
    })
